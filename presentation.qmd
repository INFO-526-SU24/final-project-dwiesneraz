...
- The dataset contains information about trash collected by four semiautonomous trash collection wheels placed around the Inner Harbor in Baltimore, MD.
...
- *There were inconsistencies in how often wheels were checked and what types of trash were counted.
...
- Only the data from 2021 and on was considered in this plot because that is the earliest that all four wheels have been active.

- The bottom two categories of trash were omitted due to two wheels not tracking two of the categories and one wheel not tracking one of the categories.
